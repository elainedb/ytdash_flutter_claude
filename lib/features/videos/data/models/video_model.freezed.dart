...
class _VideoModel extends VideoModel {
  const _VideoModel({required this.id, required this.title, required this.channelTitle, required this.thumbnailUrl, required this.publishedAt, required final  List<String> tags, this.city, this.country, this.latitude, this.longitude, this.recordingDate}): _tags = tags,super._();

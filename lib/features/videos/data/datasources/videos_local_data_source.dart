...
class VideosLocalDataSourceImpl implements VideosLocalDataSource {
  ...
  Future<void> cacheVideos(List<VideoModel> videos) async {
    try {
      ...
      for (final video in videos) {
        batch.insert('videos', _toMap(video, now),
  ...
  Future<List<VideoModel>> getVideosByChannel(String channelName) async {
    try {
      ...
      throw CacheException('Failed to get videos by channel: $e');
    }
  }
  ...
  Future<List<VideoModel>> getVideosByCountry(String country) async {
    try {
      ...
      throw CacheException('Failed to get videos by country: $e');
    }
  }
  ...
  VideoModel _fromMap(Map<String, dynamic> map) {
    return VideoModel(
      ...
      tags: (json.decode(map['tags'] as String) as List<dynamic>)
          .cast<String>(),
  ...
  Map<String, dynamic> _toMap(VideoModel video, String cachedAt) {
    return {
      'id': video.id,
      'title': video.title,

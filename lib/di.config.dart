...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i469.GeocodingService>(
      () => _i469.GeocodingService(gh<_i519.Client>()),
    );
    ...
    gh.lazySingleton<_i551.VideosRemoteDataSource>(
      () => _i551.VideosRemoteDataSourceImpl(
        httpClient: gh<_i519.Client>(),
        geocodingService: gh<_i469.GeocodingService>(),
      ),
    );
    ...
    gh.factory<_i62.AuthBloc>(
      () => _i62.AuthBloc(
        gh<_i1058.SignInWithGoogle>(),
        gh<_i950.SignOut>(),
        gh<_i422.GetCurrentUser>(),
      ),
    );
    ...
    gh.factory<_i14.VideosBloc>(() => _i14.VideosBloc(gh<_i71.GetVideos>()));
    return this;
  }
}
